...
flowchart LR
    %% 스타일 정의
    classDef importNode fill:#f0f7ff,stroke:#0078d4,stroke-width:2px,color:#004b87,font-weight:bold;
    classDef patchNode fill:#fff8e1,stroke:#ff8f00,stroke-width:2px,color:#bf360c,font-weight:bold;
    classDef setupNode fill:#f1f8e9,stroke:#43a047,stroke-width:2px,color:#1b5e20,font-weight:bold;
    classDef mainNode fill:#fff0f6,stroke:#d40071,stroke-width:3px,color:#7d0042,font-size:16px,font-weight:bold;
    classDef dimmed fill:#fafafa,stroke:#e0e0e0,stroke-width:1px,color:#bdbdbd,stroke-dasharray: 5 5;
    ...
    %% 범례(Legend) 스타일
    linkStyle 0,1,2,5,6 stroke:#333,stroke-width:2px;
    linkStyle 3,4 stroke:#ccc,stroke-width:1px;
```

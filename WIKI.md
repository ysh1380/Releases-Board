...
flowchart LR
    %% 스타일 정의
    classDef importNode fill:#f0f7ff,stroke:#0078d4,stroke-width:2px,color:#004b87;
    classDef patchNode fill:#fff8e1,stroke:#ff8f00,stroke-width:2px,color:#bf360c;
    classDef setupNode fill:#f1f8e9,stroke:#43a047,stroke-width:2px,color:#1b5e20;
    classDef mainNode fill:#fff0f6,stroke:#d40071,stroke-width:3px,color:#7d0042;
